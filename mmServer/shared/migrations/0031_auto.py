...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shared_profile', 'country',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Profile.country_visible'
        db.add_column(u'shared_profile', 'country_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profile.date_of_birth'
        db.add_column(u'shared_profile', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Profile.social_security_number_last_4_digits'
        db.add_column(u'shared_profile', 'social_security_number_last_4_digits',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Profile.bio'
        db.add_column(u'shared_profile', 'bio',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Profile.bio_visible'
        db.add_column(u'shared_profile', 'bio_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'shared_profile', 'country')

        # Deleting field 'Profile.country_visible'
        db.delete_column(u'shared_profile', 'country_visible')

        # Deleting field 'Profile.date_of_birth'
        db.delete_column(u'shared_profile', 'date_of_birth')

        # Deleting field 'Profile.social_security_number_last_4_digits'
        db.delete_column(u'shared_profile', 'social_security_number_last_4_digits')

        # Deleting field 'Profile.bio'
        db.delete_column(u'shared_profile', 'bio')

        # Deleting field 'Profile.bio_visible'
        db.delete_column(u'shared_profile', 'bio_visible')
