...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index(u'shared_message', ['status'])


        # Changing field 'Message.hash'
        db.alter_column(u'shared_message', 'hash', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding index on 'Message', fields ['hash']
        db.create_index(u'shared_message', ['hash'])


    def backwards(self, orm):
        # Removing index on 'Message', fields ['hash']
        db.delete_index(u'shared_message', ['hash'])

        # Removing index on 'Message', fields ['status']
        db.delete_index(u'shared_message', ['status'])


        # Changing field 'Message.hash'
        db.alter_column(u'shared_message', 'hash', self.gf('django.db.models.fields.TextField')(default=''))
