...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.message'
        db.add_column(u'shared_transaction', 'message',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shared.Message'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.message'
        db.delete_column(u'shared_transaction', 'message_id')
