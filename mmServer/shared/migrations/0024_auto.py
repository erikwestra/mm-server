...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.action_processed'
        db.add_column(u'shared_message', 'action_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.action_processed'
        db.delete_column(u'shared_message', 'action_processed')
