...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('shared_conversation', 'last_message',
                         'last_message_1')
        db.add_column('shared_conversation', 'last_message_2',
                      models.TextField(null=True))
        db.rename_column('shared_message', 'text', 'sender_text')
        db.add_column('shared_message', 'recipient_text',
                      models.TextField(default=""))

    def backwards(self, orm):
        db.rename_column('shared_conversation', 'last_message_1',
                         'last_message')
        db.delete_column('shared_conversation', 'last_message_2')
        db.rename_column('shared_message', 'sender_text', 'text')
        db.delete_column('shared_message', 'recipient_text')
