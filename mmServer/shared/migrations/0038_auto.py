...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.message_hash'
        db.delete_column(u'shared_transaction', 'message_hash')


    def backwards(self, orm):
        # Adding field 'Transaction.message_hash'
        db.add_column(u'shared_transaction', 'message_hash',
