...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.last_status_check'
        db.delete_column(u'shared_message', 'last_status_check')

        # Adding field 'Message.error'
        db.add_column(u'shared_message', 'error',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.last_status_check'
        db.add_column(u'shared_message', 'last_status_check',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'Message.error'
        db.delete_column(u'shared_message', 'error')
