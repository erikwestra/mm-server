...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.update_id'
        db.add_column(u'shared_profile', 'update_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Picture.update_id'
        db.add_column(u'shared_picture', 'update_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, db_index=True),
                      keep_default=False)


        # Changing field 'Message.update_id'
        db.alter_column(u'shared_message', 'update_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
        # Adding field 'Conversation.update_id'
        db.add_column(u'shared_conversation', 'update_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.update_id'
        db.delete_column(u'shared_profile', 'update_id')

        # Deleting field 'Picture.update_id'
        db.delete_column(u'shared_picture', 'update_id')


        # User chose to not deal with backwards NULL issues for 'Message.update_id'
        raise RuntimeError("Cannot reverse this migration. 'Message.update_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Message.update_id'
        db.alter_column(u'shared_message', 'update_id', self.gf('django.db.models.fields.IntegerField')(unique=True))
        # Deleting field 'Conversation.update_id'
        db.delete_column(u'shared_conversation', 'update_id')
