...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.amount_in_drops'
        db.delete_column(u'shared_message', 'amount_in_drops')

        # Adding field 'Message.system_charge'
        db.add_column(u'shared_message', 'system_charge',
    ...
    def backwards(self, orm):
        # Adding field 'Message.amount_in_drops'
        db.add_column(u'shared_message', 'amount_in_drops',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Message.system_charge'
        db.delete_column(u'shared_message', 'system_charge')
