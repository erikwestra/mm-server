...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.recipient_charge'
        db.delete_column(u'shared_message', 'recipient_charge')

        # Adding field 'Message.message_charge'
        db.add_column(u'shared_message', 'message_charge',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Message.system_charge_paid_by'
        db.add_column(u'shared_message', 'system_charge_paid_by',
                      self.gf('django.db.models.fields.TextField')(default='RECIPIENT'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.recipient_charge'
        db.add_column(u'shared_message', 'recipient_charge',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Message.message_charge'
        db.delete_column(u'shared_message', 'message_charge')

        # Deleting field 'Message.system_charge_paid_by'
        db.delete_column(u'shared_message', 'system_charge_paid_by')
    ...
    models = {
        ...
        u'shared.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message_charge': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'system_charge_paid_by': ('django.db.models.fields.TextField', [], {}),
