...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversation.encryption_key'
        db.add_column(u'shared_conversation', 'encryption_key',
                      self.gf('django.db.models.fields.TextField')(default='abc'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversation.encryption_key'
        db.delete_column(u'shared_conversation', 'encryption_key')
