...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.action'
        db.add_column(u'shared_message', 'action',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'Message.action_params'
        db.add_column(u'shared_message', 'action_params',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.action'
        db.delete_column(u'shared_message', 'action')

        # Deleting field 'Message.action_params'
        db.delete_column(u'shared_message', 'action_params')
